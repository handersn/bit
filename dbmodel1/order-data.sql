...
DDL(DATA DEFINITION LANGUAGE) 테이블, 뷰, 프로시저 등을 정의하는 문법
DML(DATA MANIPULATION LANGUAGE) 데이터를 다루는 문법
DQL(D - QUERY LANGUAGE) SELECT 문
...
values('u1','1111','u01@test.com','홍길동','111-1111');

insert into MEMBERS(UID,PWD,EMAIL,UNAME,TEL)
values('u2','1111','u02@test.com','임꺽정','111-1111');

insert into MEMBERS(UID,PWD,EMAIL,UNAME,TEL)
values('u3','1111','u03@test.com','유관순','111-1111');

insert into MEMBERS(UID,PWD,EMAIL,UNAME,TEL)
values('u4','1111','u04@test.com','안중근','111-1111');

insert into MEMBERS(UID,PWD,EMAIL,UNAME,TEL)
values('u5','1111','u05@test.com','윤봉길','111-1111');

insert into MEMBERS(UID,PWD,EMAIL,UNAME,TEL)
values('u6','1111','u06@test.com','이순신','111-1111');

insert into MEMBERS(UID,PWD,EMAIL,UNAME,TEL)
values('u7','1111','u07@test.com','김구','111-1111');

insert into MEMBERS(UID,PWD,EMAIL,UNAME,TEL)
values('u8','1111','u08@test.com','김좌진','111-1111');

insert into MEMBERS(UID,PWD,EMAIL,UNAME,TEL)
values('u9','1111','u09@test.com','안창호','111-1111');
...
/* 문제: 위의 결과를 출력할 때 아이디와 이름의 라벨명을 id,name 으로 바꿔라
 * 컬럼명 as 별명
 * 컬럼명 별명 <== as 생략가능
 * 컬럼명 (as) 별명
 * 
...
insert into MAKERS(MKNAME,HOME,TEL)
values('삼성','www.samsumg.com','100-1002');
...
values(1,'u1',1,'2014-05-07');

insert into ORDERS(PNO, UID, QTY, ODATE)
values(1,'u2',3,'2014-06-07');

insert into ORDERS(PNO, UID, QTY, ODATE)
values(2,'u1',3,'2014-07-07');

insert into ORDERS(PNO, UID, QTY, ODATE)
values(2,'u5',1,'2014-08-07');

insert into ORDERS(PNO, UID, QTY, ODATE)
values(3,'u7',6,'2014-09-07');
