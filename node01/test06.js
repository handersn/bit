/*
 * URL 에서 파라미터 값을 문자열이 아닌 객체로 추출하기
 * url.parse(URL, true); 
 * => 리턴 객체의 query에는 문자열이 아닌 객체가 들어있다.
 * 
 * */
...
http.createServer(function handler(req, res) {
    ...
    res.write('<body>');
    res.write('<h1>오호라...이것이 노드 제이에스</h1>');
